...
ActiveRecord::Schema.define(version: 20150722210245) do
  ...
  create_table "batters", force: :cascade do |t|
    ...
    t.string   "fg_alias"
    t.integer  "dk_salary"
    t.float    "dk_season_ppg"
    t.float    "zips_adj_dk_ppg"
    t.string   "dk_alias"
  end
  ...
  add_index "matchups", ["home_pitcher_id"], name: "index_matchups_on_home_pitcher_id", using: :btree
  add_index "matchups", ["visiting_pitcher_id"], name: "index_matchups_on_visiting_pitcher_id", using: :btree
  ...
  add_index "user_lines", ["matchup_id"], name: "index_user_lines_on_matchup_id", using: :btree
  add_index "user_lines", ["user_id"], name: "index_user_lines_on_user_id", using: :btree
  ...
  add_index "wagers", ["matchup_id"], name: "index_wagers_on_matchup_id", using: :btree
  add_index "wagers", ["team_id"], name: "index_wagers_on_team_id", using: :btree
